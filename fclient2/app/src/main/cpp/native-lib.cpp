...
Java_com_example_softwaredevelopment_MainActivity_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
...
Java_com_example_softwaredevelopment_MainActivity_initRng(JNIEnv *env, jclass clazz) {
...
Java_com_example_softwaredevelopment_MainActivity_randomBytes(JNIEnv *env, jclass, jint no) {
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_com_example_softwaredevelopment_MainActivity_encrypt(JNIEnv *env, jclass, jbyteArray key, jbyteArray data)
{
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_com_example_softwaredevelopment_MainActivity_decrypt(JNIEnv *env, jclass, jbyteArray key, jbyteArray data)
{
    jsize ksz = env->GetArrayLength(key);
    jsize dsz = env->GetArrayLength(data);
...
Java_com_example_softwaredevelopment_MainActivity_transaction(JNIEnv *xenv, jobject xthiz, jbyteArray xtrd) {
